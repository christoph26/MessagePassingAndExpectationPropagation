...
Before different inference approaches are explained in detail, the next section introduces factor graphs, the structure these algorithms operate on.
...
only exact for trees, also continuous variables, complexity
